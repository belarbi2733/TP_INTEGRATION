...
class GumballMachine
{
	...
	function __construct()
	{
	    try
	    {
	        ...
	        $sql="CREATE TABLE prof IF NOT EXISTS ( id INT NOT NULL AUTO_INCREMENT , nom VARCHAR(25) NOT NULL , prenom VARCHAR(25) NOT NULL , date_naissance DATE NOT NULL , lieu_naissance TEXT NOT NULL , PRIMARY KEY (id)) ";
	        $this->bdd->exec($sql);
	        $stmt->execute();
